...
(function($) {
	...
	******************************************** */
    ...
    $('.active-slider-1').slick({
        ...
        nextArrow: '<button type="button" class="arrow-next"><i class="fa fa-angle-left" aria-hidden="true"></i></button>',
    });
    ...
    $('.active-featured-product').slick({
        ...
        slidesToShow: 4,
        slidesToScroll: 1,
        prevArrow: '<button type="button" class="arrow-prev"><i class="fa fa-angle-left" aria-hidden="true"></button>',
        nextArrow: '<button type="button" class="arrow-next"><i class="fa fa-angle-right" aria-hidden="true"></button>',
        responsive: [
            {  breakpoint: 991,   settings: { slidesToShow: 3,  }  },
            {  breakpoint: 767,   settings: { slidesToShow: 1, }   },
            {  breakpoint: 479,   settings: { slidesToShow: 1, }   },
